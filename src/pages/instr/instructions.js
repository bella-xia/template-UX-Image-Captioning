    ...
    <div className="container">
      ...
      <div style={{fontSize: "20px", textAlign: "left", width:"75%", marginLeft: "10%"}}>
        ...
        <ul> 
          ...
          <li> <b>Goal:</b> Provide <b>high-quality</b> captions that enable a person with visual impairment to build memories and experiences from the photographs they encounter. </li>
      ...
      <> 
        ...
        <div style={{marginTop: "-20px", marginLeft: "35px"}}>
          <ol>
            ...
            <li> Make the corresponding changes to the original caption. You can make <b>type</b> or <b>delete edits</b> at the <b>character level at any location in the caption</b>. You can see the initial caption with the tracked changes you have made. </li>
            <li> There are <i>Undo</i> and <i>Reset</i> buttons that you can use as you modify the captions. </li>
            <li> Once you are satisfied with your final caption version, continue to the next image. Your caption will be saved.</li>
            <li> You can click to go back to the previous image only if you want to make any further change. Only use the <i>Back</i> and <i>Next</i> buttons to navigate. <b>Do not</b> use the browser’s back option or reload the webpage. </li>
      ...
      <Button disabled={!agree} variant="btn btn-success" onClick={continueChange} style={{marginTop: "-5px", marginBottom: "10px"}}>
            Continue
      </Button>
      </>
      }
      ...
      <div style={{fontSize: "20px", textAlign: "left", width: "75%", marginLeft: "10%"}}> 
      <p>  Before you start, let's consider some <b>guidelines</b> for writing captions:  </p>
